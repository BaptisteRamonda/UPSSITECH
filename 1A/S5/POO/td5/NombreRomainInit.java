...
public class NombreRomainInit {
    ...
    /**	la représentation interne entière du nombre*/
    ...
    public NombreRomainInit(int value) {
        if(value<NOMBRE_MAX)
            valeur=value;
        else
    ...
    public NombreRomainInit(String s) {
        valeur = 0;
     ...
     * */
    public void moins(NombreRomainInit n) {
     ...
     */
    public void plus(NombreRomainInit n) {
        valeur=valeur+n.valeur;
    }
}
